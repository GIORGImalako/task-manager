...
const loadApiBtn = document.getElementById("loadApiTasks");
...
function displayApiTasks(apiTasks) {
...
async function loadApiTasks() {
  apiTaskList.innerHTML = "<p>Loading...</p>";
...
loadApiBtn.addEventListener("click", loadApiTasks);
